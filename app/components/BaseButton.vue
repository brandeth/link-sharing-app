...
<template>
  <button
    :type="type"
    :disabled="disabled"
    class="inline-flex h-14 cursor-pointer items-center justify-center gap-2 rounded-lg border px-6 py-4 text-preset-3-semibold transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand disabled:cursor-not-allowed disabled:border-border disabled:bg-surface-muted disabled:text-fg-secondary"
